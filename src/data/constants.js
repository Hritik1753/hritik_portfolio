export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1GERUlJ3aUX9Li6mFKRv40DMUdcE4rd5E/view?usp=sharing",
...
export const skills = [
  ...
  export const experiences = [
    {
      id: 0,
      img: "https://images.crunchbase.com/image/upload/c_pad,f_auto,q_auto:eco,dpr_1/dv1mrsteizhiemjz4rqv?ik-sanitizeSvg=true",
      role: "Software Developer intern ",
      company: "GRIP INVEST",
      date: "Jan 2024 - May 2024",
      desc: "working on web applications using Next js Framework, Nest js for backend management, Ai Assist Chatbot project, OTP login, Ui Fixes and resolving sprint tickets ",
      skills: [
        "Next js",
        "AWS",
        "JavaScript",
      ...
      doc: " https://drive.google.com/file/d/1dRJj1PVeqwTjniErZs6Rq7qQ3eICujAr/view?usp=drive_link",
    },
        {
      id: 1,
...
export const projects = [
  ...
  },
  {
    ...
    date: "january 2024",
    description:
      "A Chill Down project which is Ai Ml based project, in which we measure the stress level of a person on the basis of their daily routine.  ",
    image:
      "https://user-images.githubusercontent.com/76893116/227752981-98e2edb3-ccdd-44cc-82bd-af42d09fac36.png",
    tags: ["Python", "Flask", "Css", "React"],
    category: "machine learning",
    github: "https://github.com/Hritik1753/chill-down",
  },
    {
    id: 11,
    ...
    date: "August 2024",
    description:
      " A Ticketing System website made with React JS, Redux, Material UI and Spring boot. It has a login page where users can log in with their Google account. it has three dashboard user, Admin, and Helper Dashboard, It has create ticket option where user can create ticket.Admin helper and user all can see the ticket and do comment on the ticket Admin can manag the all ticket and can Assign the ticket to the helper. It has a search bar where users can search for a particular ticket.",
    image:
      "https://cdn.dribbble.com/userupload/38772249/file/original-dc42b817b6e7e95e1f24b4707866c665.png?resize=2400x1800&vertical=center",
    tags: ["React Js", "Local Storage", "AWS Auth", "Spring boot", "java"],
    category: "web app",
    github: "https://github.com/Hritik1753/ticketsystem/tree/master/demo",
    webapp: "",
    // member: [
    //   {
    //     name: "Hritik Paswan",
